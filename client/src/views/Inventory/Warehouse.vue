        ...
        <template>
            ...
            >
                ...
                <v-toolbar
                    flat
                >
                    <v-toolbar-title>Warehouse's</v-toolbar-title>
                    <v-divider
                    class="mx-4"
                    inset
                    vertical
...
export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Warehouse', value: 'WarehouseName' , 'class':'white--text black darken-3 '},
    ...
    methods: {
        ...
        async deleteItemConfirm () {
            var self=this;
            await axios.post('/apitux/WarehouseAxios',{
        ...
        async save () {
            ...
            if (this.editedIndex > -1) {
                ...
                .then(function(res){
                    ...
                    axios.get(`/api/Warehouse/?search=${res.data.id}`)
                    .then(function(rsp){
