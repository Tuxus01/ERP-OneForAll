        ...
        <template>
            ...
            >
                ...
                <v-toolbar
                    flat
                >
                    <v-toolbar-title>Category's</v-toolbar-title>
                    <v-divider
                    class="mx-4"
                    inset
                    vertical
...
export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Category', value: 'CategoryName', 'class':'white--text black darken-3 ' },
    ...
    methods: {
        ...
        async deleteItemConfirm () {
            var self=this;
            await axios.post('/apitux/CategoryAxios',{
       ...
       async save () {
            ...
            if (this.editedIndex > -1) {
                ...
                .then(function(res){
                    axios.get(`/api/Category/?search=${res.data.id}`)
                    .then(function(rsp){
