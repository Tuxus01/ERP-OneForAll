        ...
        <template>
            ...
            >
                ...
                <v-toolbar
                    flat
                >
                    <v-toolbar-title>Sub Category's</v-toolbar-title>
                    <v-divider
                    class="mx-4"
                    inset
                    vertical
...
export default {
    ...
    data: () => ({
        ...
        dialogDelete: false,
        headers: [
            //{ text: 'id', value: 'id', 'class':'white--text black darken-3 ' },
            ...
            { text: 'Sub Category', value: 'SubCategoryName', 'class':'white--text black darken-3 ' },
            ...
            //{ text: 'date_create', value: 'date_create' , 'class':'white--text black darken-3 '},
    ...
    methods: {
        ...
        async deleteItemConfirm () {
            var self=this;
            await axios.post('/apitux/SubCategoryAxios',{
        ...
        async save () {
            ...
            if (this.editedIndex > -1) {
                ...
                .then(function(res){
                    axios.get(`/api/SubCategory/?search=${res.data.id}`)
                    .then(function(rsp){
