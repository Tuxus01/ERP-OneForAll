...
export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Warehouse', value: 'Warehouse.WarehouseName' , 'class':'white--text black darken-3 '},
            { text: 'Bin', value: 'Bin' , 'class':'white--text black darken-3 '},
    ...
    methods: {
        ...
        async deleteItemConfirm () {
            var self=this;
            await axios.post('/apitux/BinAxios',{
        ...
        async save () {
            ...
            if (this.editedIndex > -1) {
                ...
                .then(function(res){
                    ...
                    axios.get(`/api/Bins/?search=${res.data.id}`)
                    .then(function(rsp){
